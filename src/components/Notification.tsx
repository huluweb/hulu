...
const NotificationsPage = () => {
  ...
  const markAsRead = async (id: string) => {
    try {
      // Update backend
      await fetch(`https://holuweb.onrender.com/api/notifications/${id}`, {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const markAllAsRead = async () => {
    try {
      // Update backend
      await fetch('https://holuweb.onrender.com/api/notifications/mark-all', {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json',
  ...
  const clearAll = async () => {
    try {
      ...
      await fetch('https://holuweb.onrender.com/api/notifications', {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
