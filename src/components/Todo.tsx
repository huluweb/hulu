...
const TodoApp: React.FC = () => {
  ...
  const fetchTasks = async () => {
    setIsLoading(true);
    try {
      const response = await axiosInstance.get('https://holuweb.onrender.com/api/tasks');
  ...
  const addTask = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post('https://holuweb.onrender.com/api/tasks', newTask);
...
const updateTask = async () => {
  ...
  const deleteTask = async (id: string) => {
    setIsLoading(true);
    try {
      await axiosInstance.delete(`https://holuweb.onrender.com/api/tasks/${id}`);
